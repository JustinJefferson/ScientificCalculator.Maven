...
*/
    ...
    public static Double calcArcSin(Double incoming, Boolean isRadians) {
        ...
        if (isRadians) {
            if (incoming % 2*Math.PI == 0.0) {
                return null;
            } else if (incoming % 2*Math.PI == 2*Math.PI/2.0) {
                return null;
            }
        }
        else {
        ...
        if (isRadians) {
            ...
            result = Math.asin(Math.toRadians(incoming));
        }
    ...
    public static Double calcArcCos(Double incoming, Boolean isRadians) {
        ...
        if (isRadians) {
            ...
            result = Math.acos(Math.toRadians(incoming));
        }
    ...
    public static Double calcArcTan(Double incoming, Boolean isRadians) {
        ...
        if (isRadians) {
            ...
            result = Math.atan(Math.toRadians(incoming));
        }
